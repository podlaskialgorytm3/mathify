    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="container mx-auto px-4 py-12 sm:py-20">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-6xl font-bold text-gray-900 mb-4 sm:mb-6 bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
            Mathify
          </h1>
          <p className="text-lg sm:text-2xl text-gray-700 mb-4 sm:mb-6 font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center sm:flex-wrap">
            <Link href="/login">
              <Button size="lg" className="w-full sm:w-auto text-base sm:text-lg px-8 sm:px-10 py-5 sm:py-6">
                Zaloguj się
              </Button>
            </Link>
            <Link href="/register">
          ...
          <div className="grid gap-6 sm:gap-8 md:grid-cols-3 max-w-6xl mx-auto">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all hover:scale-105 hover:shadow-2xl">
                ...
                <div className="text-3xl sm:text-5xl font-bold text-white mb-2 sm:mb-3">Łatwe</div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all hover:scale-105 hover:shadow-2xl">
                ...
                <div className="text-3xl sm:text-5xl font-bold text-white mb-2 sm:mb-3">
                  Szybkie
                </div>
                <p className="text-blue-100 text-base sm:text-lg">
      ...
      <div className="container mx-auto px-4 py-14 sm:py-24">
        <div className="text-center mb-12 sm:mb-20">
          ...
          <p className="text-center text-gray-600 text-base sm:text-xl max-w-2xl mx-auto">
            Kompleksowe narzędzia dla nowoczesnej edukacji matematycznej
          </p>
        </div>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 sm:gap-8 max-w-6xl mx-auto">
      ...
      {/* Benefits Section */}
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 py-14 sm:py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-4xl font-bold text-center mb-10 sm:mb-16">
            Dlaczego Mathify?
          </h2>
          <div className="grid gap-8 md:grid-cols-3 sm:gap-10 max-w-5xl mx-auto">
      ...
      {/* Roles Section */}
      <div className="container mx-auto px-4 py-12 sm:py-20">
        <h2 className="text-2xl sm:text-4xl font-bold text-center mb-4">Dla kogo?</h2>
        <p className="text-center text-gray-600 mb-10 sm:mb-16 text-base sm:text-lg">
          Mathify dostosowuje się do Twoich potrzeb
        </p>
        <div className="grid gap-6 md:grid-cols-3 sm:gap-8 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center sm:flex-wrap">
            ...
            <Link href="/login">
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto text-base sm:text-lg px-8 sm:px-10 py-5 sm:py-6 bg-transparent text-white border-white hover:bg-white hover:text-blue-600"
              >
                Mam już konto
              </Button>
            </Link>
