  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-6">
        <div className="w-10 h-10 flex-shrink-0 bg-blue-600 rounded-xl flex items-center justify-center">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl">Dysk</h1>
